...
Not every sentence deserves the full template. Use judgment:

- **Full six-part treatment**: sentences that introduce a new grammar point, a trap, an idiom, or
  a structure not yet covered — especially anything tagged [Diverges from English].
- **Compressed (2–4 lines)**: sentences that repeat a structure already fully explained a few
  sentences earlier. Just note "same structure as sentence X" and move on, maybe with just the
  translation and one new vocabulary item.
- **One-liner**: interjections, exclamations, exact filler ("Incroyable.", "Trop bon.", "Ça va").
  Translation + IPA + maybe one register note is enough.

A useful ratio to aim for on a ~60–80 sentence authentic transcript: roughly 60% full treatment,
30% compressed, 10% one-liners. A teaching-podcast transcript (Simply French style) will skew much
more compressed since it deliberately repeats the same 3–4 structures dozens of times — don't
re-explain "je voudrais" fifteen times.
